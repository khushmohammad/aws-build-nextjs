            ...
            <div className="chat chat d-flex other-user">
              <div className="chat-detail">
                <div className="chat-message">
                  <p>Absolutely!</p>
                  <p>
                    SocialV Dashboard is the responsive bootstrap 5 admin
                    template.
                  </p>
                </div>
              </div>
          ...
          <div className="chat-footer d-flex p-2 bg-white align-items-center">
            ...
            <div className="position-relative">
              <Form className="d-flex align-items-center " action="#">
                <Form.Control type="text" className="me-1" placeholder="Aa" />
              </Form>
              <i className="material-symbols-outlined md-18 text-primary emoji-btn">
                sentiment_satisfied
              </i>
            </div>
            <div className="chat-header-icons d-flex">
