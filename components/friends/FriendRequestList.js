    ...
    <div>
      <Card>
        <Card.Body>
          {apiError && (
            <Card>
              <Card.Body>{apiError}</Card.Body>
            </Card>
          )}

          {!friendRequestList ||
          friendRequestList.length < 1 ||
          !Array.isArray(friendRequestList) ? (
            <Card>
              <p className="text-center py-3">No Request Found! </p>
            </Card>
          ) : (
            friendRequestList &&
                      ...
                      <div className="d-flex align-items-center">
                        {data.friendRequestBy && (
                          <Image
                            ...
                            src={
                              data.friendRequestBy?.profilePictureInfo?.file
                                ?.location || user1
                            }
                            alt=""
                            height={53}
                        ...
                        <div className="ms-3">
                          <h6 className="mb-0 ">
                            {" "}
                            {data.friendRequestBy &&
                              `${data.friendRequestBy.userInfo.firstName}   ${data.friendRequestBy.userInfo.lastName} `}
                          </h6>
