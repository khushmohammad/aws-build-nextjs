    ...
    <Container>
      <div className="">
        ...
        >
                  ...
                  {commentlist && (
                    <>
                      <CommentList
                        postId={postId}
                        comment={comment}
                        refreshcommetlist={getCommentList}
                      />
                    </>
                  )}
                </React.Fragment>
          ...
          {showLoadMoreButton ? (
            <>
              <p role="button" onClick={LoadMore}>
                {" "}
                View more comments{" "}
              </p>
            </>
...
const CommentReplyViewOne = ({ postId, parentId, commmetLevel }) => {
  ...
  const getCommentReplyList = async () => {
    const res = await getCommentbyPostId(
      postId,
      page,
      limit,
      updatedLevel,
  ...
  return (
    ...
    >
      {commentReplylist &&
        commentReplylist.map((comment, i) => {
          return (
            <React.Fragment key={i}>
              <CommentList
                postId={postId}
                comment={comment}
                refreshcommetlist={getCommentReplyList}
              />
              {/* <form >
