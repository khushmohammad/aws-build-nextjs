...
function index() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            await setSuccessMessage("Help created successfully")
        } catch (err) {
                ...
                <Row>
                    <Col sm={9} className="ms-auto">
                        ...
                        <Form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            {/* <Form.Group className="mb-3" controlId="secretIdentity">
                                <Form.Label>Secret Identity</Form.Label>
                                <Form.Control {...register("secretIdentity")} type="text" placeholder="Enter Secret Identity" />
                            ...
                            <Form.Group className="mb-3" controlId="formBasicCheckbox">
                                <Form.Check onChange={() => setChecked(!checked)}  {...register("secretIdentity")} defaultChecked={checked} type="checkbox" label="Enter Secret Identity" />
                                <p>{errors.secretIdentity?.message}</p>
                            </Form.Group>
