...
function Commentapi() {
    ...
    const onFormSubmit = async (e) => {
        ...
        const res = await postCommentByPostId("63e3a0e01b2f4232326a3c34", commentInputText, 0)
...
const CommentReplyViewOne = ({ parentId, commmetLevel }) => {
    ...
    return (
        <ul className="post-comments list-inline p-0 m-0 ms-4">
                    ...
                    <React.Fragment key={i}>
                        ...
                        <>
                            ...
                            {comment.repliesCounts > 0 &&
                                <>
                                    <CommentReplyViewOne parentId={comment._id} />
                                </>
                            }
                        </>
                    </React.Fragment>
