...
function Commentapi() {
    ...
    const getCommentList = async () => {
        const res = await getCommentbyPostId("63e3a0e01b2f4232326a3c34", 1, 2, 0, "")
...
const CommentReplyViewOne = ({ parentId, commmetLevel }) => {
    ...
    const getCommentReplyList = async () => {
        const res = await getCommentbyPostId("63e3a0e01b2f4232326a3c34", 1, 2, updatedLevel, parentId)
        const commentrepArr = await res?.comments
