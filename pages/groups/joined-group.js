          ...
          <div className="d-grid gap-3 d-grid-template-1fr-19">
            ...
            <div className="card mb-0">
              ...
              <div className="card-body text-center">
                ...
                <div className="group-info pt-3 pb-3">
                  <h4>
                    <Link href="/groups/12345">R & D</Link>
                  </h4>
                  <p>Lorem Ipsum data</p>
                </div>
                <div className="group-details d-inline-block pb-3">
            ...
            <Card className=" mb-0">
              ...
              <Card.Body className=" text-center">
                ...
                <div className="group-info pt-3 pb-3">
                  <h4>
                    <Link href="/groups/12345">Graphics</Link>
                  </h4>
                  <p>Lorem Ipsum data</p>
                </div>
                <div className="group-details d-inline-block pb-3">
            ...
            <div className="card mb-0">
              ...
              <div className="card-body text-center">
                ...
                <div className="group-info pt-3 pb-3">
                  <h4>
                    <Link href="/groups/12345">Developer</Link>
                  </h4>
                  <p>Lorem Ipsum data</p>
                </div>
                <div className="group-details d-inline-block pb-3">
            ...
            <Card className=" mb-0">
              ...
              <Card.Body className="text-center">
                ...
                <div className="group-info pt-3 pb-3">
                  <h4>
                    <Link href="/groups/12345">Tester</Link>
                  </h4>
                  <p>Lorem Ipsum data</p>
                </div>
                <div className="group-details d-inline-block pb-3">
            ...
            <Card className="mb-0">
              ...
              <Card.Body className="text-center">
                ...
                <div className="group-info pt-3 pb-3">
                  <h4>
                    <Link href="/groups/12345">Events</Link>
                  </h4>
                  <p>Lorem Ipsum data</p>
                </div>
                <div className="group-details d-inline-block pb-3">
            ...
            <Card>
              ...
              <Card.Body className=" text-center">
                ...
                <div className="group-info pt-3 pb-3">
                  <h4>
                    <Link href="/groups/12345">Coder</Link>
                  </h4>
                  <p>Lorem Ipsum data</p>
                </div>
                <div className="group-details d-inline-block pb-3">
            ...
            <Card>
              ...
              <Card.Body className=" text-center">
                ...
                <div className="group-info pt-3 pb-3">
                  <h4>
                    <Link href="/groups/12345">Themes</Link>
                  </h4>
                  <p>Lorem Ipsum data</p>
                </div>
                <div className="group-details d-inline-block pb-3">
            ...
            <Card>
              ...
              <Card.Body className="text-center">
                ...
                <div className="group-info pt-3 pb-3">
                  <h4>
                    <Link href="/groups/12345">Review</Link>
                  </h4>
                  <p>Lorem Ipsum data</p>
                </div>
                <div className="group-details d-inline-block pb-3">
