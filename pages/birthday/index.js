                                                    ...
                                                    <div className="iq-birthday-block">
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div className="d-flex align-items-center">
                                                                <Link href="#">
                                                                    <Image src={user5} alt="profile-img" className="img-fluid"/>
                                                                </Link>
                                                ...
                                                <Card.Body>
                                                        <div className="iq-birthday-block">
                                                            <div className="d-flex align-items-center justify-content-between">
                                                                <div className="d-flex align-items-center">
                                                                    <Link href="#">
                                                                        <Image src={user6} alt="profile-img" className="img-fluid"/>
                                                                    </Link>
                                                                    <div className="friend-info ms-0 ms-md-3 mt-md-0 mt-2">
                                                                        <h5>Petey Cruiser</h5>
                                                                        <p className="mb-0">Today</p>
                                                ...
                                                <Card.Body>
                                                    <div className="iq-birthday-block">
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div className="d-flex align-items-center">
                                                                <Link href="#">
                                                                    <Image src={user7} alt="profile-img" className="img-fluid"/>
                                                                </Link>
                                                                <div className="friend-info ms-0 ms-md-3 mt-md-0 mt-2">
                                                                    <h5>Petey Cruiser</h5>
                                                ...
                                                <Card.Body>
                                                        <div className="iq-birthday-block">
                                                            <div className="d-flex align-items-center justify-content-between">
                                                                <div className="d-flex align-items-center">
                                                                    <Link href="#">
                                                                        <Image src={user8} alt="profile-img" className="img-fluid"/>
                                                                    </Link>
                                                                    <div className="friend-info ms-0 ms-md-3 mt-md-0 mt-2">
                                                                        <h5>Paul Molive</h5>
                                                                        <p className="mb-0">Tomorrow</p>
                                                ...
                                                <Card.Body>
                                                        <div className="iq-birthday-block">
                                                            <div className="d-flex align-items-center justify-content-between">
                                                                <div className="d-flex align-items-center">
                                                                    <Link href="#">
                                                                        <Image src={user9} alt="profile-img" className="img-fluid"/>
                                                                    </Link>
                                                                    <div className="friend-info ms-0 ms-md-3 mt-md-0 mt-2">
                                                                        <h5>Paige Turner</h5>
                                                ...
                                                <Card.Body>
                                                    <div className="iq-birthday-block">
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div className="d-flex align-items-center">
                                                                <Link href="#">
                                                                    <Image src={user10} alt="profile-img" className="img-fluid"/>
                                                                </Link>
                                                                <div className="friend-info ms-0 ms-md-3 mt-md-0 mt-2">
                                                                    <h5>Bob Frapples</h5>
                                                ...
                                                <Card.Body>
                                                    <div className="iq-birthday-block">
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div className="d-flex align-items-center">
                                                                <Link href="#">
                                                                    <Image src={user13} alt="profile-img" className="img-fluid"/>
                                                                </Link>
                                                                <div className="friend-info ms-0 ms-md-3 mt-md-0 mt-2">
                                                                    <h5>Barb Ackue</h5>
                                                                    <p className="mb-0">15-jan-2020</p>
                                                ...
                                                <Card.Body>
                                                    <div className="iq-birthday-block">
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div className="d-flex align-items-center">
                                                                <Link href="#">
                                                                    <Image src={user14} alt="profile-img" className="img-fluid"/>
                                                                </Link>
                                                                <div className="friend-info ms-0 ms-md-3 mt-md-0 mt-2">
                                                                    <h5>Greta Life</h5>
                                                ...
                                                <Card.Body>
                                                    <div className="iq-birthday-block">
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div className="d-flex align-items-center">
                                                                <Link href="#">
                                                                    <Image src={user15} alt="profile-img" className="img-fluid"/>
                                                                </Link>
                                                                <div className="friend-info ms-0 ms-md-3 mt-md-0 mt-2">
                                                                    <h5>Ira Membrit</h5>
                                                ...
                                                <Card.Body>
                                                    <div className="iq-birthday-block">
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div className="d-flex align-items-center">
                                                                <Link href="#">
                                                                    <Image src={user16} alt="profile-img" className="img-fluid"/>
                                                                </Link>
                                                                <div className="friend-info ms-0 ms-md-3 mt-md-0 mt-2">
                                                                    <h5>Pete Sariya</h5>
                                                ...
                                                <Card.Body>
                                                    <div className="iq-birthday-block">
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div className="d-flex align-items-center">
                                                                <Link href="#">
                                                                    <Image src={user17} alt="profile-img" className="img-fluid"/>
                                                                </Link>
                                                                <div className="friend-info ms-0 ms-md-3 mt-md-0 mt-2">
                                                                    <h5>Monty Carlo</h5>
                                                ...
                                                <Card.Body>
                                                    <div className="iq-birthday-block">
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div className="d-flex align-items-center">
                                                                <Link href="#">
                                                                    <Image src={user18} alt="profile-img" className="img-fluid"/>
                                                                </Link>
                                                                <div className="friend-info ms-0 ms-md-3 mt-md-0 mt-2">
                                                                    <h5>Ed Itorial</h5>
                                                ...
                                                <Card.Body>
                                                    <div className="iq-birthday-block">
                                                        <div className="d-flex align-items-center justify-content-between">
                                                            <div className="d-flex align-items-center">
                                                                <Link href="#">
                                                                    <Image src={user19} alt="profile-img" className="img-fluid"/>
                                                                </Link>
                                                                <div className="friend-info ms-0 ms-md-3 mt-md-0 mt-2">
                                                                    <h5>Paul Issy</h5>
