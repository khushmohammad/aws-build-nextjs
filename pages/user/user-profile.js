                ...
                <div className="profile-header">
                  ...
                  >
                    ...
                    <ul
                      ...
                      style={{ zIndex: "1" }}
                    >
                      <li onClick={() => setShowCoverImageDropzone(true)}>
                  ...
                  {showCoverImageDropzone ? (
                    <CoverPicUploader
                      closeDropzone={() => setShowCoverImageDropzone(false)}
                    />
                  ) : null}
                  <div className="user-detail text-center mb-3">
                    ...
                    {showImageDropzone ? (
                      <Uploader
                        closeDropzone={() => setShowImageDropzone(false)}
                      />
                    ) : null}
                      ...
                      <Col lg={4}>
                        ...
                        <Card>
                          ...
                          <Card.Body>
                            <ul className="profile-img-gallary p-0 m-0 list-unstyled">
                              <li>
                                <Link onClick={() => imageOnSlide(1)} href="#">
                                  <Image
                                    loading="lazy"
                                    src={g1}
                                    alt="gallary"
                              ...
                              <li>
                                <Link onClick={() => imageOnSlide(2)} href="#">
                                  <Image
                                    loading="lazy"
                                    src={g2}
                                    alt="gallary"
                              ...
                              <li>
                                <Link onClick={() => imageOnSlide(3)} href="#">
                                  <Image
                                    loading="lazy"
                                    src={g3}
                                    alt="gallary"
                              ...
                              <li>
                                <Link onClick={() => imageOnSlide(4)} href="#">
                                  <Image
                                    loading="lazy"
                                    src={g4}
                                    alt="gallary"
                              ...
                              <li>
                                <Link onClick={() => imageOnSlide(5)} href="#">
                                  <Image
                                    loading="lazy"
                                    src={g5}
                                    alt="gallary"
                              ...
                              <li>
                                <Link onClick={() => imageOnSlide(6)} href="#">
                                  <Image
                                    loading="lazy"
                                    src={g6}
                                    alt="gallary"
                              ...
                              <li>
                                <Link onClick={() => imageOnSlide(7)} href="#">
                                  <Image
                                    loading="lazy"
                                    src={g7}
                                    alt="gallary"
                              ...
                              <li>
                                <Link onClick={() => imageOnSlide(8)} href="#">
                                  <Image
                                    loading="lazy"
                                    src={g8}
                                    alt="gallary"
                              ...
                              <li>
                                <Link onClick={() => imageOnSlide(9)} href="#">
                                  <Image
                                    loading="lazy"
                                    src={g9}
                                    alt="gallary"
                        ...
                        <Card>
                          <div className="card-header d-flex justify-content-between">
                            ...
                            <div className="card-header-toolbar d-flex align-items-center">
                              <p className="m-0">
                                <Link href="javacsript:void();">Add New </Link>
                              </p>
                            </div>
                          </div>
                          <Card.Body>
                            ...
                            <Tab.Content>
                              <Tab.Pane eventKey="about1">
                                ...
                                <Row className="mb-2">
                                  ...
                                  <div className="col-9">
                                    {user && user.userInfo ? (
                                      <p className="mb-0">{user.userInfo.firstName} {user.userInfo.middleName} {user.userInfo.lastName}</p>
                                    ) : (
                                      "---"
                                    )}
                                  </div>
                              ...
                              <Tab.Pane eventKey="about2">
                                ...
                                <h4 className="mb-3">Hobbies and Interests</h4>
                                <ul className="suggestions-lists m-0 p-0">
