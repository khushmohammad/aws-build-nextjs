...
import { getStateData, getCityData, getCountryData } from "../../services/profile.service";
...
const UserProfileEdit = ({ countries }) => {
  ...
  const coverImage = useSelector((state) => state.user.cover_picture);
  const [userData, setUserData] = useState();
  const [showImageDropzone, setShowImageDropzone] = useState(false);
  const [showCoverImageDropzone, setShowCoverImageDropzone] = useState(false);
  ...
  const [formdata, setFormdata] = useState({
    ...
    profileDescription : user.profileDescription? user.profileDescription :null,
  ...
  const handleState = async (e) => {
    ...
    await setFormdata({...formdata,state:e.target.value == "" ? null : e.target.value})
...
// Fetching all citites
  ...
  const updatePersonalInfo = async (e) => {
    ...
    // const isValid = await userSchema.isValid(formdata.firstName);
    // console.log("VALIDITY of FIRSTNAME", isValid);
                      ...
                      <Form onSubmit={updatePersonalInfo}>
                            ...
                            <Col md="6 relative">
                              ...
                              >
                                ...
                                <div
                                  className="p-image d-flex justify-content-center align-items-center"
                                  onClick={() =>
                                    setShowCoverImageDropzone(true)
                                  }
                                >
                                  <span className="material-symbols-outlined upload-button text-white">
                                    edit
                              ...
                              {showCoverImageDropzone ? (
                                <CoverPicUploader
                                  closeDropzone={() =>
                                    setShowCoverImageDropzone(false)
                                  }
                                />
                              ) : null}
                            </Col>
                        ...
                        <Row className="align-items-center">
                          ...
                          <Form.Floating className="form-group col-sm-6">
                            ...
                            />
                            <Form.Label htmlFor="mname" className="form-label">
                              Middle Name
                            </Form.Label>
                          </Form.Floating>
                          <Form.Floating className="form-group col-sm-6">
                          ...
                          <Form.Floating className="form-group col-sm-6">
                            <Form.Control
                              ...
                              onChange={(e) =>
                                setFormdata({
                                  ...formdata,
                                  nickName: e.target.value == ""?null : e.target.value,
                                })
                              }
                            />
                            <Form.Label htmlFor="lname" className="form-label">
                          ...
                          <Form.Floating className="form-group col-sm-12">
                            <Form.Control
                              ...
                              onChange={(e) =>
                                setFormdata({
                                  ...formdata,
                                  profileDescription: e.target.value == ''? null : e.target.value,
                                })
                              }
                            />
                            <Form.Label htmlFor="lname" className="form-label">
                              ...
                              <div>
                                <div className="form-check custom-radio form-check-inline">
                                  <input
                                    ...
                                    value="Male"
                                    checked={
                                      formdata.userInfo.gender == "Male" && true
                                    }
                          ...
                          <Form.Group className="form-group col-sm-6">
                            ...
                            <DatePicker
                              ...
                              onChange={(date) => {
                                ...
                                setFormdata({...formdata,userInfo:{...formdata.userInfo,dateOfBirth:date}});
                                // onBlur();
                              }}
                              className="form-control"
                            />
                          ...
                          <Form.Floating className="form-group col-sm-6">
                            <Form.Select
                              ...
                              onChange={(e) =>
                                setFormdata({
                                  ...formdata,
                                  maritalStatus: e.target.value == "" ? null : e.target.value
                                })
                              }
                            >
                              <option value=''>
                          ...
                          <Form.Floating className="mb-3">
                            <Form.Control
                              ...
                              onChange={(e) =>
                                setFormdata({
                                  ...formdata,
                                  address: e.target.value==''?null:e.target.value,
                                })
                              }
                              style={{ lineHeight: "32px" }}
                          ...
                          <Form.Floating className="form-group col-sm-6">
                            <Form.Control
                              ...
                              onChange={(e) =>
                                setFormdata({
                                  ...formdata,
                                  pinCode: e.target.value== "" ? null : e.target.value,
                                })
                              }
                            />
                            <Form.Label htmlFor="cname" className="form-label">
